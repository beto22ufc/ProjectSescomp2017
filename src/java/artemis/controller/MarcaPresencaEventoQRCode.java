 ...
 * @author Wallison
 */
@WebServlet(name = "MarcaPresencaEventoQRCode", urlPatterns = {"/MarcaPresencaEventoQRCode"})
public class MarcaPresencaEventoQRCode extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            EventoBeans evento = facade.getEvento(Long.parseLong(request.getParameter("evento")));
            InscricaoBeans inscricao = null;
            for(InscricaoBeans i : evento.getInscricoes()){
            ...
            if(inscricao !=null){
                facade.marcaPresencaInscricaoEvento(evento, inscricao);
