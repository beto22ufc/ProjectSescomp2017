 ...
 * @author Wallison
 */
@WebServlet(name = "ImagemGaleriaUpload", urlPatterns = {"/ImagemGaleriaUpload"})
public class ImagemGaleriaUpload extends HttpServlet {
       ...
       boolean isMultiPart = FileUpload.isMultipartContent(request);
        if(isMultiPart){
            ...
            try{
                ...
                RequestDispatcher rd = request.getRequestDispatcher("/painelUsuario/evento/adicionaImagemGaleria/?e="+evento.getNome().toLowerCase().replace(" ", "_")+"_"+evento.getCodEvento());
