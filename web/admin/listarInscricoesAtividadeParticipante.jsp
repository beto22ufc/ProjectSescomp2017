...
<%
    ...
    if(session.getAttribute("usuario") != null && (((UsuarioBeans) session.getAttribute("usuario")).getTipo().contains("participante"))){
%>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <jsp:include page="/${dir}/admin/pags/listarInscricoesAtividadeParticipante.jsp" ></jsp:include>
  </div>
  <!-- /.content-wrapper -->
