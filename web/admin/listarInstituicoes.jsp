...
<%
    ...
    if(session.getAttribute("usuario") != null && ((UsuarioBeans) session.getAttribute("usuario")).getTipo().contains("adminSite")){
%>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <jsp:include page="/${dir}/admin/pags/listarInstituicoes.jsp" ></jsp:include>
  </div>
  <!-- /.content-wrapper -->
