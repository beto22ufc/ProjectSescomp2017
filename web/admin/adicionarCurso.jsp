...
<%
    ...
    if(session.getAttribute("usuario") != null && ((UsuarioBeans) session.getAttribute("usuario")).getTipo() !=null && ((UsuarioBeans) session.getAttribute("usuario")).getTipo().contains("adminSite")){
%>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <jsp:include page="/${dir}/admin/pags/adicionarCurso.jsp" ></jsp:include>
  </div>
  <!-- /.content-wrapper -->
