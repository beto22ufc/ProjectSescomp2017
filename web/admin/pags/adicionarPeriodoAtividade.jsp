...
<section class="content-header">
      <h1>
          ADICIONAR PERÍODO(S) PARA A ATIVIDADE <b><%=atividade.getNome().toUpperCase() %></b>
            ...
            try{
                ...
                for(int i=0;i<inicioTempos.length;i++){
                    if(inicioDatas[i] != null && inicioTempos[i] != null && terminoDatas[i] != null && terminoTempos[i] != null)
                        atividade.getPeriodoBeanses().add(new PeriodoBeans(LocalDateTime.parse(inicioDatas[i]+" "+inicioTempos[i], formatter), LocalDateTime.parse(terminoDatas[i]+" "+terminoTempos[i], formatter)));
                }
