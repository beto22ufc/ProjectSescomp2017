...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Atualizar instituição</li>
      </ol>
    </section>
    <%
        ...
        if(request.getParameter("atualiza") != null){
            try{
                ...
                request.setAttribute("msg", "Instituição atualizada com sucesso!");
            }catch(NumberFormatException e){
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><%=(request.getAttribute("msg") != null) ? request.getAttribute("msg") : "Atualize essa isntituição" %></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="" method="post">
              <div class="box-body">
                ...
                <label>Nome</label>
                    <input type="text" class="form-control" id="nome" placeholder="Nome da instituição" name="nome" value="<%=(request.getParameter("nome") != null) ? request.getParameter("nome") : (instituicao != null && instituicao.getNome() != null) ? instituicao.getNome() : ""%>">
                </div>
              <!-- /.form group -->  
              </div>
              <!-- /.box-body -->
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary" name="atualiza" value="instituicao">Atualizar instituição</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
