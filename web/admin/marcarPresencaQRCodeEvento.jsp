...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <jsp:include page="/${dir}/admin/pags/marcarPresencaQRCodeEvento.jsp" ></jsp:include>
  </div>
  <!-- /.content-wrapper -->
...
<script type="text/javascript">
  ...
  (function () {
    ...
    function resultHandler (err, result) {
      ...
      alert(result);
      marcarPresenca(<%=f.getCodFromParameter(request.getParameter("e")) %>, result);
    }
    ...
    function marcarPresenca(evento, p){
        if(isNumeric(evento) && (evento>0)){
            $.get("/ArtemisTCC/MarcaPresencaEventoQRCode", {evento: evento, p: p
            }, function (data) {
                alert(data);
            });
        }else{
            alert("Evento e/ou inscrição inválida!");
        }
    }
