...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    %>
      <p class="login-box-msg"><%= (request.getAttribute("msg") != null) ? request.getAttribute("msg") : "Recuperar senha"%></p>
    ...
    <form action="" method="post">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
            <button type="submit" class="btn btn-primary btn-block btn-flat" name="recuperar" value="senha">Recuperar</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
