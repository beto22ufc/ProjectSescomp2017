<%-- 
    Document   : footer
    Created on : 31/08/2017, 16:57:06
    Author     : Usuario
--%>
<section>
    <%
                        ...
                        <div class="container">
                            <div class="wthree-foo-grids">
                                <div class="col-md-3 wthree-footer-grid">
                                    <h4 class="footer-head">Quem somos?</h4>
                                    <p>Entusiastas em desenvolvimento e engenharia de software que buscam realizar o melhor trabalho para atender as necessidades
                                    dos usuários.</p>
                                    <p></p>
                                </div>
                                <div class="col-md-3 wthree-footer-grid">
                                ...
                                <div class="col-md-3 wthree-footer-grid">
                                    ...
                                    <ul>
                                        <li><a href="termo.html"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Termos de Uso</a></li>
                                    </ul>
                                </div>
                                <div class="col-md-3 wthree-footer-grid">
                                    <h4 class="footer-head">Contatos</h4>
